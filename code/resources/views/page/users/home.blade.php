...
<div>
	<center>		
		@foreach($match as $m)
		<img src="source/image/matches/banner{{$m->id}}.jpg">
		<table>
			<tr>
				<th>Team 1 </th>
				<th>Team 2</th>
...
<div class="col-sm-12">
	...
	<div class="col-sm-6">
		...
		<form action="{{route('post_bet')}}" method="post">
			...
			<input type="number" value="0" name="amount">  APC</input>
	...
	<div class="col-sm-5" style="backgroud-color:red;">
		...
		<div class="alert alert-danger col-sm-9">{{Session::get('thatbai')}}</div>
		@endif
	</div>
</div>
@section('script')
