		...
		<center>
			...
			<form action="{{route('admin_post_match')}}" method="post">
				...
				<div class="form-group">
					...
					<select class="form-control" name="u_result">
		...
		<center>
			...
			<table class="table">
				...
				<ul class="alert alert-danger">
					<li>Update Matche : You must choose Match's Id want to fix, then choose fields want to fix ... don't need full !</li>
					<li>Add Matche : You must fill every fields.</li>
					<li>Loading : waiting result.</li>
